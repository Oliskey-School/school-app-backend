...
router.get('/', auth_middleware_1.authenticate, (0, tenant_middleware_1.requireRole)(['SuperAdmin']), SchoolController.listSchools);
router.get('/:id', auth_middleware_1.authenticate, SchoolController.getSchoolById);
router.put('/:id', auth_middleware_1.authenticate, SchoolController.updateSchool);
